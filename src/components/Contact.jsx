          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex flex-col">
                ...
                <input required type="text" name="name" value={formData.name} onChange={handleChange} placeholder='"Suyash Sharma"' className="bg-transparent border-b border-border-grid focus:border-accent outline-none py-1 text-text-primary px-2 transition-colors" />
              </div>
              <div className="flex flex-col">
                <label className="text-accent mb-1">$ email =</label>
                <input required type="email" name="email" value={formData.email} onChange={handleChange} placeholder='"sharmasuyash135@gmail.com"' className="bg-transparent border-b border-border-grid focus:border-accent outline-none py-1 text-text-primary px-2 transition-colors" />
              </div>
              <div className="flex flex-col">
